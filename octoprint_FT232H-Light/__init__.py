	...
	def get_update_information(self):
		return dict(
			octolight=dict(
				...
				user="gigibu5",
				repo="FT232H-Light",
				pip="https://github.com/oldmanbluntz/FT232H-Light/archive/{target}.zip"
			)
		)

__plugin_pythoncompat__ = ">=2.7,<4"
__plugin_implementation__ = FT232H-LightPlugin()
